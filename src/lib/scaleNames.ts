...
const hundredsComponent: string[] = [
  "",
  "centi",
  "ducenti",
  "trecenti",
...
function buildUnderHundredPrefix(n: number): string {
  if (n < 0 || n >= 100) {
