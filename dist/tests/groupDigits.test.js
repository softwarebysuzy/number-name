...
const groupDigits_1 = require("../src/lib/groupDigits");
const cases = [
    ["0", ["0"]],
    ["7", ["7"]],
    ["123", ["123"]],
...
for (const [input, expected] of cases) {
    const actual = (0, groupDigits_1.groupDigits)(input);
...
for (const [input, expectedMessage] of invalidCases) {
    let threw = false;
    try {
        (0, groupDigits_1.groupDigits)(input);
    }
    catch (error) {
        threw = true;
...
const longResult = (0, groupDigits_1.groupDigits)(longInput);
